...
#let meta = crear-meta((
  ...
  anio: 2026, correlativo: 2, version: "1.0.0", fecha-codigo: "20260622",
  tipo-largo: "Informe Técnico",
  titulo: "Otro documento de prueba", subtitulo: "SLEP Chinchorro",
...
#s-ficha(meta, rama-git: "doc/TI-INF-SFW-2026-0002")
#s-versiones((
  ("v1.0.0", "2026-06-22", "Andres Cubillos Salazar", "Versión inicial."),
))
#s-distribucion((
